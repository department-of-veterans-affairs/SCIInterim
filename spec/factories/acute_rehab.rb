FactoryGirl.define do
  ...
  factory :acute_rehab do
    ...
    reason_for_admission { AcuteRehab.reason_for_admission.keys.sample }
    ...
    residence_type { AcuteRehab.residence_type.keys.sample }
