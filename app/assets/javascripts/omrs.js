...
$(document).ready(function() {
  ...
  showWhenValueEquals("[name='omr[start_asia_attributes][is_complete]']", "true", "#asia_form_start_zone_of_partial_preservation");
  ...
  showWhenValueEquals("[name='omr[finish_asia_attributes][is_complete]']", "true", "#asia_form_finish_zone_of_partial_preservation");
